...
namespace Fizzyo
{
    public class FizzyoDevice1 : MonoBehaviour
    {
        //public 
        ...
        //Singleton
        private static FizzyoDevice1 instance;
        ...
        public static FizzyoDevice1 Instance()
        {
            if (instance == null)
            {
                lock (threadLock)
                {
                    if (instance == null)
                    {
                        instance = GameObject.FindObjectOfType<FizzyoDevice1>();
                    }

                    if (instance == null)
                    {
                        instance = (new GameObject("FizzyoDevice1")).AddComponent<FizzyoDevice1>();
                    }
